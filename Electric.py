...
st.title("💧⚡ ប្រព័ន្ធគណនាវិក្កយបត្រ ទឹក-អគ្គិសនី")
st.write("សូមបំពេញព័ត៌មានខាងក្រោមដើម្បីគណនាថ្លៃទឹកប្រាក់៖")
st.divider()
...
st.divider()
tab1, tab2 = st.tabs(["⚡ គណនាថ្លៃភ្លើង", "💧 គណនាថ្លៃទឹក"])
with tab1:
    st.header("ស្វែងរកថ្លៃអគ្គិសនី")
...
">🖨️ ព្រីនវិក្កយបត្រ (Print)</button>
"""
