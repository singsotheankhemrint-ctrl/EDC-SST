...
def log_data(user_id, user_name, date_line, elec_old, elec_new, elec_total, water_old, water_new, water_total, room_fee, debt, grand_total, created_by):
    ...
    if os.path.exists(LOG_FILE):
        try:
            # 💡 ដោះស្រាយ ParserError៖ បើទម្រង់ជួរឈរខុសគ្នា វានឹងបង្កើតឯកសារថ្មីដើម្បីកុំឱ្យគាំង
...
# បង្ហាញឈ្មោះអ្នកប្រើប្រាស់នៅលើ Sidebar
...
# =========================================================
# 🍏 ផ្នែកកម្មវិធីចម្បង (រំសាយ Tabs ចោល រៀបចំចុះក្រោមវិញ)
# =========================================================
...
# --- 💧 ផ្នែកគណនាថ្លៃទឹក (នៅខាងក្រោមភ្លើង) ---
